...
class analysis_time_commit_hist:
    ...
    def run(self):
        ...
        # We strip rather than keep tz-aware because pandas 1.x, 2.x and 3.x
        # all handle tz-naive comparisons consistently, whereas tz-aware
        # comparison behaviour changed across versions and causes TypeError on
        # pandas 1.x.
